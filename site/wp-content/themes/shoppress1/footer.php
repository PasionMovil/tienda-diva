<?php require(gp_inc . 'options.php'); global $gp_settings, $dirname, $themename; ?>
			...
			<div id="footer">
				...
				<div id="copyright"><?php if(get_option($dirname."_footer_content")) { echo stripslashes(get_option($dirname."_footer_content")); } else { ?><?php _e('Copyright &copy;', 'gp_lang'); ?> <?php echo date('Y'); ?> <?php echo $themename; ?>. <?php _e('All rights reserved.', 'gp_lang'); ?><?php } ?> <?php wp_footer(); ?></div>
