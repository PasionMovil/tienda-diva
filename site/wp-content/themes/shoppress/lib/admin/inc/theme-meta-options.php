...
function gp_post_meta_boxes() {
	...
	'portfolio_settings' => array('name' => 'portfolio_settings', 'type' => 'open', 'desc' => __('Can be used when your posts are displayed in <code>[posts]</code> shortcodes.', 'gp_lang'), 'title' => __('Portfolio Settings', 'gp_lang')),
		...
		$dirname.'_custom_url' => array('name' => $dirname.'_custom_url', 'title' => __('Custom URL', 'gp_lang'), 'desc' => __('A custom URL which your image links to (overrides the default post URL).', 'gp_lang'), 'type' => 'text', 'details' => '', 'size' => ''),
	...
	'format_settings' => array('name' => 'format_settings', 'type' => 'open', 'desc' => __('General formatting settings.', 'gp_lang'), 'title' => __('Format Settings', 'gp_lang')),
		...
		$dirname.'_custom_stylesheet' => array('name' => $dirname.'_custom_stylesheet', 'title' => __('Custom Stylesheet URL', 'gp_lang'), 'desc' => __('Enter the relative URL to your custom stylesheet e.g. <code>lib/css/custom-style.css</code>.', 'gp_lang'), 'std' => '', 'type' => 'text', 'details' => ''),
...
function gp_page_meta_boxes() {
	...
	'format_settings' => array('name' => 'format_settings', 'type' => 'open', 'desc' => __('General formatting settings.', 'gp_lang'), 'title' => __('Format Settings', 'gp_lang')),
		...
		$dirname.'_custom_stylesheet' => array('name' => $dirname.'_custom_stylesheet', 'title' => __('Custom Stylesheet URL', 'gp_lang'), 'desc' => __('Enter the relative URL to your custom stylesheet e.g. <code>lib/css/custom-style.css</code>.', 'gp_lang'), 'details' => '', 'std' => '', 'type' => 'text'),
...
function gp_slide_meta_boxes() {
	...
	'caption_settings' => array('name' => 'caption_settings', 'type' => 'open', 'desc' => __('The settings for a caption in this slide.', 'gp_lang'),  'title' => __('Caption Settings', 'gp_lang')),
		...
		$dirname.'_slide_caption_link_text' => array('name' => $dirname.'_slide_caption_link_text', 'title' => __('Caption Link Text', 'gp_lang'), 'desc' => __('Enter the your caption link text.', 'gp_lang'), 'details' => '',  'size' => '', 'type' => 'text'),
						
		$dirname.'_slide_caption_link' => array('name' => $dirname.'_slide_caption_link', 'title' => __('Caption Link', 'gp_lang'), 'desc' => __('Enter the URL you want your caption link text to link to.', 'gp_lang'), 'details' => '',  'size' => '', 'type' => 'text'),
...
function gp_save_meta_data($post_id) {
	...
	foreach ($meta_boxes as $meta_box) :
		...
		elseif(isset($_POST['post_type']) && 'product' == $_POST['post_type'] && !current_user_can('edit_post', $post_id))
			return $post_id;
