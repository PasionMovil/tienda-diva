...
if ( yit_product_form_position_is('in-sidebar') )  remove_action( 'woocommerce_single_product_summary', 'woocommerce_template_single_price', 10 );
if ( yit_product_form_position_is('in-sidebar') ) remove_action( 'woocommerce_single_product_summary', 'woocommerce_template_single_add_to_cart', 30 );
if ( yit_product_form_position_is('in-sidebar') && yit_get_option('shop-detail-show-price') )  add_action( 'yit_product_box', 'woocommerce_template_single_price', 10 );
if ( yit_product_form_position_is('in-sidebar') && yit_get_option('shop-detail-add-to-cart') ) add_action( 'yit_product_box', 'woocommerce_template_single_add_to_cart', 20 );
...
function woocommerce_template_loop_product_thumbnail() {
    ...
    if ( ! yit_get_option( 'shop-use-second-image', 1 ) ) return;
...
function yit_size_images_style() {
    ...
    ?>
        ...
        .single-product div.images > a img{ width:<?php echo yit_shop_large_w() ?>px; height:<?php echo yit_shop_large_h() ?>px; }
    <?php
    endif;
    ?>
        /* WooCommerce standard images */
...
function woocommerce_show_product_outofstock_flash() {
    woocommerce_get_template( 'loop/outofstock-flash.php' );
}
