	...
	class RevSliderAdmin extends UniteBaseAdminClassRev{
		...
		public static function checkCopyCaptionsCSS(){
			...
			if(!file_exists(GlobalsRevSlider::$filepath_captions) == true){
				self::setStartupError("Can't copy <b>captions-original.css </b> to <b>captions.css</b> in <b> plugins/revolution-slider/rs-plugin/css </b> folder. Please try to copy the file by hand or turn to support.");
			}
